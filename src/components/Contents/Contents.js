...
dispatch(getActionMovie());
    ...
    return (
        <div>
            ...
            <MovieRow movies={TrenddingMovie} title="Trending Moives" idSection='trending'/>
            <MovieRow movies={TopRatedMovie} title="Top Rated Moives" idSection='rated'/>
            ...
            <MovieRow movies={RomanceMovie} title="Romance Moives"idSection='romance'/> 
